...
class ResponseDishGet(ResponseFoodGet):
    # id: int
    ...
    ingredients: list[ResponseFoodGet] = Field(..., ge=0, le=100, description="Содержание углеводов на 100 грамм продукта, от 0 до 100 грамм")
    description: str = Field(..., min_length=1, max_length=5000, description="Описание блюда, от 1 до 5000 символов")
