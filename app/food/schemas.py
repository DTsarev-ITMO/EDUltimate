...
class ResponseFoodUpdate(BaseModel):
    name: str = Field(..., description="Название продукта для поиска")
    new_name: str = Field(None, min_length=1, max_length=50, description="Новое название продукта, от 1 до 50 символов")
