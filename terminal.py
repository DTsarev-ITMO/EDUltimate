...
if __name__ == "__main__":
    # ans = asyncio.run(
    #     register_user(external=True, user_data=ResponseUserRegister(name="admin", email="admin@admin.ru", password="password"))
    # )
    # ans = asyncio.run(
    #     auth_user(external=True, response=Response(), user_data=ResponseUserAuth(email="admin@admin.ru", password="password"))
    # )
    # ans = asyncio.run(
